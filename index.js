...
const groups = Object.fromEntries(yamlEntries('groups'));
...
const snapshots = Object.fromEntries(yamlEntries('snapshots'));
...
for (const [key, data] of yamlEntries('features')) {
    ...
    const stringToStringArray = (value) => typeof value === "string" ? [value] : value;
